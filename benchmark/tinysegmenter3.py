...
def tokenize(text):
    ...
    for i in range(4, len(seg) - 3):
        ...
        score += _UP2.get(p2, 0)
        score += _UP3.get(p3, 0)
        score += _BP1.get(p1 + p2, 0)
        score += _BP2.get(p2 + p3, 0)
        score += _UW1.get(w1, 0)
        score += _UW2.get(w2, 0)
        score += _UW3.get(w3, 0)
        score += _UW4.get(w4, 0)
        score += _UW5.get(w5, 0)
        score += _UW6.get(w6, 0)
        score += _BW1.get(w2 + w3, 0)
        score += _BW2.get(w3 + w4, 0)
        score += _BW3.get(w4 + w5, 0)
        score += _TW1.get(w1 + w2 + w3, 0)
        score += _TW2.get(w2 + w3 + w4, 0)
        score += _TW3.get(w3 + w4 + w5, 0)
        score += _TW4.get(w4 + w5 + w6, 0)
        score += _UC1.get(c1, 0)
        score += _UC2.get(c2, 0)
        score += _UC3.get(c3, 0)
        score += _UC4.get(c4, 0)
        score += _UC5.get(c5, 0)
        score += _UC6.get(c6, 0)
        score += _BC1.get(c2 + c3, 0)
        score += _BC2.get(c3 + c4, 0)
        score += _BC3.get(c4 + c5, 0)
        score += _TC1.get(c1 + c2 + c3, 0)
        score += _TC2.get(c2 + c3 + c4, 0)
        score += _TC3.get(c3 + c4 + c5, 0)
        score += _TC4.get(c4 + c5 + c6, 0)
        #  score += _TC5.get(c4 + c5 + c6, 0)
        score += _UQ1.get(p1 + c1, 0)
        score += _UQ2.get(p2 + c2, 0)
        score += _UQ3.get(p3 + c3, 0)
        score += _BQ1.get(p2 + c2 + c3, 0)
        score += _BQ2.get(p2 + c3 + c4, 0)
        score += _BQ3.get(p3 + c2 + c3, 0)
        score += _BQ4.get(p3 + c3 + c4, 0)
        score += _TQ1.get(p2 + c1 + c2 + c3, 0)
        score += _TQ2.get(p2 + c2 + c3 + c4, 0)
        score += _TQ3.get(p3 + c1 + c2 + c3, 0)
        score += _TQ4.get(p3 + c2 + c3 + c4, 0)
        p = "O"
        if score > 0:
            result.append(word)
            word = ""
